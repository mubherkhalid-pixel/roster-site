...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    .shiftFilterBtn .emoji {{ 
      font-size:22px;
      position:relative;
      z-index:1;
    }}
    .shiftFilterBtn .label {{ display:none; }}
    ...
    @media (max-width:480px){{
      ...
      .shiftFilterBtn {{ width:46px; height:46px; }}
      .shiftFilterBtn .emoji {{ font-size:20px; }}
    }}
