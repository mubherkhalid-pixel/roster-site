...
<div class="wrap">
  ...
  <div class="summaryBar">
    ...
    {"" if is_now_page else f'''
    <a href="{cta_url}" class="summaryChip" style="text-decoration:none;background:linear-gradient(135deg,#1e40af,#1976d2);color:#fff;cursor:pointer;transition:transform .2s;">
      <div class="chipVal" style="color:#fff;">🔄</div>
      <div class="chipLabel" style="color:rgba(255,255,255,.9);">Current Shift</div>
    </a>
    '''}
  </div>
  ...
  <div class="shiftFilterBar">
    <button class="shiftFilterBtn morning" data-shift="Morning">
    ...
    <button class="shiftFilterBtn all active" data-shift="All" style="color:#1e40af;">
      <span class="emoji">📋</span>
...
(function(){{
  ...
  // Set active shift on load - default to All
  filterBtns.forEach(function(btn){{
    if(btn.dataset.shift === 'All'){{
  ...
  // Auto-filter on page load - show all shifts by default
  filterShifts('All');
}})();
</script>
